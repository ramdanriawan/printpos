...
try {
    ...
    $img = EscposImage::load(__DIR__ . "/logo.bmp", false);
    ...
    $printer -> bitImageColumnFormat($tux, Escpos::IMG_DOUBLE_WIDTH);
    $printer -> text("Wide Tux.\n");
    $printer -> feed();

    $printer -> bitImageColumnFormat($tux, Escpos::IMG_DOUBLE_HEIGHT);
    $printer -> text("Tall Tux.\n");
    $printer -> feed();

    $printer -> bitImageColumnFormat($tux, Escpos::IMG_DOUBLE_WIDTH | Escpos::IMG_DOUBLE_HEIGHT);
