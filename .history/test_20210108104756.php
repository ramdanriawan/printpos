...
try {
    ...
    $printer->text("Tanggal         : asdasdsadasdasd\n");
    $printer->text("Nama Hewan      : asdasdsadasdasd\n");
    $printer->text("Jenis Hewan     : asdasdsadasdasd\n");
    $printer->text("Umur            : asdasdsadasdasd\n");
    $printer->text("Jenis Kelamin   : asdasdsadasdasd\n");
    $printer->text("Ras / Breed     : asdasdsadasdasd\n");
    $printer->text("Warna           : asdasdsadasdasd\n");
    $printer->text("Pemilik         : asdasdsadasdasd\n");
    $printer->text("Alamat / Telp   : asdasdsadasdasd\n");
    $printer->text("No. Rekam Medis : asdasdsadasdasd\n");
    $printer->text("Total Biaya     : asdasdsadasdasd\n");
    $printer->text("===============================\n");
